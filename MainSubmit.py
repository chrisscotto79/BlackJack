# Description: program a card game with a credit system and a betting system.
# Christopher Scotto COP 1500
...
def editCreditsTXT():
    ...
    print("You decided to edit the amount of credits that you curently own!")
    ...
    try:
        ...
        print("There was an error with the file. Please try again later.")
        return
    ...
    while edit != "q":
        ...
        if edit == "add":
           ...
           #subtract edit from the playersMoney
            subtract = input("How much do you want to subtract from your credits? ")
            ...
            multiply = input("How much do you want to multiply your credits by? ")
        ...
        # Edit the player's credits to exponciate their credits
        elif edit == "exponciate":
            #exponciate the playersMoney by edit
            exponciate = input("How much do you want to exponciate your credits by? ")
        ...
        #If the player wants to modulate their credits
            ...
            modulate = input("How much do you want to modulate your credits by? ")
    ...
    print("You have exited the edit credits menu. \nThe game will now continue.")
...
def rules():
   ...
   print("Thank you for playing Christopher's Blackjack game! \nLet's play! \n")
...
def blackJack(betPlace):
   ...
   #select a random card from the deck
    ...
    print("  ♦️The dealer's cards are: " + dealersCard1 + " and " + dealersCard2)
    print("  ♦️The dealer's total is: " + str(int(dealersCard1) + int(dealersCard2)))
    ...
    if hit == "y" or hit == "Y"  :
        ...
        print("Your new total is: " + str(int(playersCard1) + int(playersCard2) + int(playersCard3)))
        print("\n")
        ...
        while int(dealersCard1) + int(dealersCard2) < 17:
            ...
            print("The dealer's new total is: " + str(int(dealersCard1) + int(dealersCard2) + int(dealersCard3)))
            print("\n")
            ...
            elif int(dealersCard1) + int(dealersCard2) + int(dealersCard3) > int(playersCard1) + int(playersCard2) + int(playersCard3):
                print("The dealer got closer to 21 than you! You lose, better luck next time!")
                subtractmoney = open("credit.txt", "w")
                subtractmoney.write(str(playerMoney - betPlace))
                subtractmoney.close()
                file = open("credit.txt", "r")
        ...
        elif int(playersCard1) + int(playersCard2) + int(playersCard3) > int(dealersCard1) + int(dealersCard2):
        ...
        #If the player's total is further from 21 than the dealer's, they lose
            ...
            print("You got further from 21 than the dealer! You lose, better luck next time!")
            subtractmoney = open("credit.txt", "w")
            subtractmoney.write(str(playerMoney - betPlace))
            subtractmoney.close()
            file = open("credit.txt", "r")
    ...
    #If the player doesn't want to hit, they don't get another card
        ...
        while int(dealersCard1) + int(dealersCard2) < 17:
            ...
            #If the dealer's total is 21, they win
                ...
                return
            #If the dealer's total is closer to 21 than the player's, they win
            elif int(dealersCard1) + int(dealersCard2) + int(dealersCard3) > int(playersCard1) + int(playersCard2):
                print("The dealer got closer to 21 than you! You lose, better luck next time!")
                subtractmoney = open("credit.txt", "w")
                subtractmoney.write(str(playerMoney - betPlace))
                subtractmoney.close()
        ...
        #If the player's total is closer to 21 than the dealer's, they win
        if int(playersCard1) + int(playersCard2) > int(dealersCard1) + int(dealersCard2):
            print("You got closer to 21 than the dealer! You win!!🏆")
            addmoney = open("credit.txt", "w")
            addmoney.write(str(playerMoney + betPlace))
            addmoney.close()
            ...
            return
        #If the player's total is further from 21 than the dealer's, they lose
        elif int(playersCard1) + int(playersCard2) < int(dealersCard1) + int(dealersCard2):
            print("You got further from 21 than the dealer! You lose, better luck next time!")
            subtractmoney = open("credit.txt", "w")
            subtractmoney.write(str(playerMoney - betPlace))
            subtractmoney.close()
...
def main(playersCredits):
    ...
    creditsInput = input("Would you like to edit your credits? (y/n) ")
    ...
    while credits > 0:
        ...
        #use the not function to check if the player's bet is a number
        if not playerBet:
        ...
        # If the player's bet is greater than 10, tell them they can't bet that much
        if playerBet > 100:
            print("You can't bet that much!")
            continue
 
 
        # If the player's bet is greater than their money, tell them they don't have enough money
        if playerBet > credits:
            print("You don't have enough money!")
            print("You have " + str(credits) + " credits left. \nThanks for playing!")
            break

        # If the player's bet is less than 0, tell them they can't bet that little
        if playerBet < 0:
            print("You can't bet that little!")
            continue
 
 
        # If the player has no credits left, tell them they have no credits left
        if credits < 0:
